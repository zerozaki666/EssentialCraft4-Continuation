...
public class TileAnimalSeparator extends TileMRUGeneric {
	...
	public void separate(boolean b) {
		...
		List<EntityAgeable> tp = worldObj.getEntitiesWithinAABB(EntityAgeable.class, toTeleport);
		List<EntityAgeable> ntp = worldObj.getEntitiesWithinAABB(EntityAgeable.class, noTeleport);
