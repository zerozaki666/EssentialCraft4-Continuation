...
public class BlockMINInjector extends BlockContainer {
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess p_149719_1_, int p_149719_2_, int p_149719_3_, int p_149719_4_) {
    	...
    	if(metadata == 0 || metadata == 6)
    		setBlockBounds(0.35F, 0F, 0.35F, 0.65F, 0.5F, 0.65F);
    	else if(metadata == 1 || metadata == 7)
    		setBlockBounds(0.35F, 0.45F, 0.35F, 0.65F, 1F, 0.65F);
    	else if(metadata == 2 || metadata == 8)
    		setBlockBounds(0.35F, 0.35F, 0F, 0.65F, 0.65F, 0.5F);
    	else if(metadata == 3 || metadata == 9)
    		setBlockBounds(0.35F, 0.35F, 0.5F, 0.65F, 0.65F, 1F);
    	else if(metadata == 4 || metadata == 10)
    		setBlockBounds(0F, 0.35F, 0.35F, 0.5F, 0.65F, 0.65F);
    	else if(metadata == 5 || metadata == 11)
    		setBlockBounds(0.5F, 0.35F, 0.35F, 1F, 0.65F, 0.65F);
